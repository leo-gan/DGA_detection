...
if __name__ == '__main__':
    ...
    dga_configurations = [
        ...
        ('oGkS3w3sGGOGG7oc', 'ssrgwnrmgrxe', ('com',), 10000),
        # https://johannesbader.ch/2015/04/new-top-level-domains-for-tinbas-dga
        ('jc74FlUna852Ji9o', 'blackfreeqazyio', ('com', 'net', 'in', 'ru'), 10000),
        ...
        ('yqokqFC2TPBFfJcG', 'watchthisnow.', ('pw', 'us', 'xyz', 'club'), 10000),
        # https://github.com/baderj/domain_generation_algorithms/commit/c7d154a39bb172c4632f7565e0c9380e8b36c18e
        ('j193HsnW72Yqns7u', 'j193hsne720uie8i', ('com', 'net', 'biz', 'org'), 10000),
    ]
    ...
    hard_coded = []
    hard_coded.extend(
        ('newstatinru', 'justforyou0987', 'phpsitegooddecoder'))
    ...
    hard_coded.extend(
        ('santaluable', 'santanyr', 'ervaluable', 'larnasa'))
